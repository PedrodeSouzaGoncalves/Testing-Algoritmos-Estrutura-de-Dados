/* Implementa uma lista COM cabeca onde todos os itens sao alocados dinamicamente
*
* Prof. Gustavo Kikee
* https://kikee.com.br/ensino-de-engenharia/algoritmos-e-programacao/
*
* Licenca MIT conforme arquivo LICENSE.txt
* 18/11/2024 
*
*/
...
void insereFim(Item* cabeca, int valor){
  ...
  // chegando na ultima posicao, coloca o ponteiro pro novo elemento
  atual->prox = novo;  
}
...
void imprime(Item* cabeca){
  ...
  // laco que executa at  o ultimo item
  int i = 0;
  while(atual!=NULL){      
